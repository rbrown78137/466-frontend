...
const Login = ({
  ...
  return (
    ...
    <div className="flex h-screen items-center">
      <div className="mt-80 ml-80 h-screen w-full max-w-xs">
        <form
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <button
              className="focus:shadow-outline rounded bg-blockNavy py-2 px-4 font-bold text-white hover:bg-blockDarkBlue focus:outline-none"
              type="submit"
            ...
            <a
              className="inline-block align-baseline text-sm font-bold text-blockNavy hover:text-blockDarkBlue"
              href="#"
            >
              Forgot Password?
            </a>
          ...
          <a
            className="mt-6 ml-10 inline-block align-baseline text-sm font-bold text-blockNavy hover:text-blockDarkBlue"
