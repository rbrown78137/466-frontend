...
const Register = ({ handleHaveAccount, errorMessage }) => {
  ...
  return (
    ...
    <div className="mt-80 ml-80 w-full max-w-xs">
      {/*Register banner at the top of the box*/}
      <form
        className="mb-4 rounded bg-blockSky px-8 pt-6 pb-3 shadow-md"
        onSubmit={handleSubmit2}
      >
        <h1 className="px-24 pb-6 text-lg font-bold text-blockNavy">Register</h1>
        {/*Email box styling*/}
        <div className="mb-4">
          <label className="mb-2 block text-sm font-bold text-gray-700" for="email">
            Email
          </label>
          <input
        ...
        <div className="flex items-center justify-between">
          <button
            className="focus:shadow-outline mb-6 rounded bg-blockNavy py-2 px-4 font-bold text-white hover:bg-blockDarkBlue focus:outline-none"
            type="submit"
          ...
          <a
            className=" inline-block pb-5 align-baseline text-sm font-bold text-blockNavy hover:text-blockDarkBlue"
      ...
      <p className="text-center text-xs text-gray-500">
        &copy;2023 block. All rights reserved.
      </p>
    </div>
  );
};
